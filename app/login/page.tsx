    ...
    <main className="min-h-screen bg-dark flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-semibold mx-auto mb-4">
            F
          </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-[#161616] border border-[#222] text-white text-sm font-medium px-4 py-2.5 rounded-lg hover:bg-[#1a1a1a] hover:border-[#333] transition-colors mb-4"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-sm font-medium py-2.5 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 mt-1"
          >
